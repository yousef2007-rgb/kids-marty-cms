        ...
        <>
            <div className='flex'>
                <div className="rounded-md flex-1 shadow-md bg-white p-3 flex items-center">
                    <div className="w-[300px] animate-pulse h-6 bg-gray-300 rounded"></div>
                </div>
            ...
            <div className="rounded-md shadow-md bg-white my-5 p-5 flex flex-col">
                <div className='my-2 animate-pulse flex items-center'>
                    <div className="w-[150px] h-[150px] bg-gray-300 rounded mr-5"></div>
